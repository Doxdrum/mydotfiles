...
The variable =org-ditaa-jar-path= 

#+BEGIN_SRC emacs-lisp
(setq org-ditaa-jar-path
      "/home/oscar/mydotfiles/emacs.d/org-mode/contrib/scripts/ditaa.jar")
#+END_SRC

**** Enable languages evaluation

The option =org-babel-load-languages= controls which languages are enabled 
for evaluation (by default only =emacs-lisp= is enabled). This variable can 
be set using the customization interface or by adding code like the 
